...
double arm_joint_state[6] = {0,0,0,0,0,0.8};
   // test();
    pose test_pos;
    roz test_roz;
    test_roz.x = 0;
    ...
    test_pos.position.x = -0.1245;
    test_pos.position.y = 0.004355;
    test_pos.position.z = 1.03;
    test_pos.orientation.w = 0.999975;
    test_pos.orientation.x = -0.005;
    test_pos.orientation.y = 0;
    test_pos.orientation.z = 0.005;
    pos resulta,resultb;
